...
public class Defaults {
    ...
    public static final int SHARE_GROUP_STATE_TOPIC_PARTITIONS = 50;
    public static final short SHARE_GROUP_STATE_TOPIC_REPLICATION_FACTOR = 3;
    public static final int SHARE_GROUP_STATE_TOPIC_SEGMENT_BYTES = 100 * 1024 * 1024;
