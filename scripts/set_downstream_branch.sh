...
kafkaMuckrakeVersionMap["2.6"]="6.0.x"
kafkaMuckrakeVersionMap["2.7"]="6.1.x"
kafkaMuckrakeVersionMap["2.8"]="6.2.x"
...
kafkaMuckrakeVersionMap["4.1"]="8.1.x"
kafkaMuckrakeVersionMap["4.2"]="8.2.x"
