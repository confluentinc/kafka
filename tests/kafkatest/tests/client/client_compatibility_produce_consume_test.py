...
from kafkatest.version import DEV_BRANCH, LATEST_0_10_0, LATEST_0_10_1, LATEST_0_10_2, LATEST_0_11_0, LATEST_1_0, \
    ...
    LATEST_2_8, LATEST_3_0, LATEST_3_1, LATEST_3_2, LATEST_3_3, KafkaVersion, V_2_6_3, V_2_7_2, V_2_8_1
...
class ClientCompatibilityProduceConsumeTest(ProduceConsumeValidateTest):
    ...
    @cluster(num_nodes=9)
    @matrix(broker_version=[str(LATEST_3_1)], client_version=[str(V_2_6_3), str(V_2_7_2), str(V_2_8_1), str(LATEST_3_1)], metadata_quorum=quorum.all_non_upgrade)
