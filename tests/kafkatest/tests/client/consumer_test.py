...
class OffsetValidationTest(VerifiableConsumerTest):
    ...
    @cluster(num_nodes=7)
    @matrix(clean_shutdown=[True], bounce_mode=["all", "rolling"], metadata_quorum=quorum.non_upgrade_quorums)
    ...
    @cluster(num_nodes=7)
    @matrix(clean_shutdown=[True], static_membership=[True, False], bounce_mode=["all", "rolling"], num_bounces=[5], metadata_quorum=quorum.non_upgrade_quorums)
    ...
    @cluster(num_nodes=7)
    @matrix(bounce_mode=["all", "rolling"], metadata_quorum=quorum.non_upgrade_quorums)
    ...
    @matrix(num_conflict_consumers=[1, 2], fencing_stage=["stable", "all"], metadata_quorum=quorum.non_upgrade_quorums)
    ...
    @cluster(num_nodes=7)
    @matrix(clean_shutdown=[True], enable_autocommit=[True, False], metadata_quorum=quorum.non_upgrade_quorums)
    ...
    @cluster(num_nodes=7)
    @matrix(clean_shutdown=[True, False], enable_autocommit=[True, False], metadata_quorum=quorum.non_upgrade_quorums)
...
class AssignmentValidationTest(VerifiableConsumerTest):
    ...
    @matrix(assignment_strategy=["org.apache.kafka.clients.consumer.RangeAssignor",
                                 ...
                                 "org.apache.kafka.clients.consumer.StickyAssignor"], metadata_quorum=quorum.non_upgrade_quorums)
