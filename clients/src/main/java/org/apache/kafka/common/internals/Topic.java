...
public class Topic {
    ...
    public static final String SHARE_STATE_TOPIC_NAME = "__share_group_state";
    ...
    private static final Set<String> INTERNAL_TOPICS = Collections.unmodifiableSet(
            Utils.mkSet(GROUP_METADATA_TOPIC_NAME, TRANSACTION_STATE_TOPIC_NAME, SHARE_STATE_TOPIC_NAME));
