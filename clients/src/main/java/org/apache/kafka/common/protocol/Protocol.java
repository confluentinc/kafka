...
public class Protocol {
    ...
    public static final Schema TOPIC_PRODUCE_DATA_V0 = new Schema(new Field("topic", STRING),
                                                                  new Field("data", new ArrayOf(new Schema(new Field("partition", INT32),
                                                                                                     new Field("record_set", LOG_BUFFER)))));
    ...
    /* Transactions API */
    public static final Schema GET_PRODUCER_ID_REQUEST_V0 = new Schema(
            new Field("appid",
                    STRING,
                    "The appid whose pid we want to retrieve or generate.")
    );

    public static final Schema GET_PRODUCER_ID_RESPONSE_V0 = new Schema(
            new Field("pid",
                    STRING,
                    "The PID for the input appid. If the input appid was empty, then this is used only for ensuring idempotence of messages")
    );

    public static final Schema[] GET_PRODUCER_ID_REQUEST = new Schema[] {GET_PRODUCER_ID_REQUEST_V0};

    public static final Schema[] GET_PRODUCER_ID_RESPONSE = new Schema[] {GET_PRODUCER_ID_RESPONSE_V0};
    ...
    static {
        ...
        REQUESTS[ApiKeys.INIT_PRODUCER_ID.id] = GET_PRODUCER_ID_REQUEST;
        ...
        RESPONSES[ApiKeys.INIT_PRODUCER_ID.id] = GET_PRODUCER_ID_RESPONSE;
