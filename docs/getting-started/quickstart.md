...
[Download](https://www.apache.org/dyn/closer.cgi?path=/kafka/4.0.1/kafka_2.13-4.0.1.tgz) the latest Kafka release and extract it: 
...
The [Kafka Streams demo](/documentation/streams/quickstart) and the [app development tutorial](/40/documentation/streams/tutorial) demonstrate how to code and run such a streaming application from start to finish. 
