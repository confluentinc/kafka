...
import org.apache.kafka.streaming.processor.internals.StreamTask;
...
public class ProcessorTopologyTestDriver {
    ...
    public ProcessorTopologyTestDriver(StreamingConfig config, TopologyBuilder builder, String... storeNames) {
        ...
        // Wrap the topology so that we can discover the ProcessingContext ...
        ProcessorTopology contextSettingTopology = new TopologyWrapper(topology);
        ...
        task = new StreamTask(id, consumer, producer, restoreStateConsumer, partitionsByTopic.values(), contextSettingTopology, config);
        assert context != null;
    }
    ...
    private class TopologyWrapper extends ProcessorTopology {

        private final ProcessorTopology delegate;

        public TopologyWrapper(ProcessorTopology delegate) {
            super(delegate);
        ...
        public void init(ProcessorContext context) {
            ProcessorTopologyTestDriver.this.context = context;
