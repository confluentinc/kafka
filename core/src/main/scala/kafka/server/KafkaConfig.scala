...
object KafkaConfig {
  ...
  val TransactionStateLogMinISRProp = "transaction.state.log.min.isr"
  val TransactionsLoadBufferSizeProp = "transaction.state.log.load.buffer.size"
  val TransactionsCommitRequiredAcksProp = "transaction.state.log.required.acks"
  ...
  val TransactionsTopicCompressionCodecProp = "transaction.state.log.compression.codec"
  /** ********* Quota Configuration ***********/
