...
class KafkaApisTest extends Logging {
  ...
  def testDescribeConfigsConsumerGroup(): Unit = {
    ...
    cgConfigs.put(CONSUMER_ASSIGNMENT_INTERVAL_MS_CONFIG, GroupConfig.CONSUMER_ASSIGNMENT_INTERVAL_MS_DEFAULT.toString)
    cgConfigs.put(SHARE_ASSIGNMENT_INTERVAL_MS_CONFIG, GroupConfig.SHARE_ASSIGNMENT_INTERVAL_MS_DEFAULT.toString)
    cgConfigs.put(STREAMS_ASSIGNMENT_INTERVAL_MS_CONFIG, GroupConfig.STREAMS_ASSIGNMENT_INTERVAL_MS_DEFAULT.toString)
