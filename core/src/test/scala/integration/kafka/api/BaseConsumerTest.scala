...
object BaseConsumerTest {
  ...
  class SerializerImpl extends Serializer[Array[Byte]] {
    ...
    override def configure(configs: Map[String, _], isKey: Boolean): Unit = serializer.configure(configs, isKey)
  ...
  class DeserializerImpl extends Deserializer[Array[Byte]] {
    ...
    override def configure(configs: Map[String, _], isKey: Boolean): Unit = deserializer.configure(configs, isKey)
